...
public class App 
{
    ...
    {
    	sLogger.log(Level.FINE, "Andrew - App main()");
    ...
    {
    	sLogger.log(Level.FINE, "Andrew - App clearDB() - Enter");
    	
    	if (mContext == null)
    	{
    		sLogger.log(Level.FINE, "Andrew - App clearDB() ERROR - Invalid Context");    		    		
    	}
    ...
    {
    	sLogger.log(Level.FINE, "Andrew - App populateDB() - Enter");
    	
    	if (mContext == null)
    	{
    		sLogger.log(Level.FINE, "Andrew - App populateDB() - ERROR Invalid Context");    	    	
    	}
		...
		try 
		{
			...
			sLogger.log(Level.FINE, "Andrew - App populating DB Status = " + execution.getStatus());
		} 
		catch (Exception e) 
		{
			e.printStackTrace();
